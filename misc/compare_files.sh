...
MD5_DEBUG_1=$(md5sum czkawka_cli_debug_1 krokiet_debug_1 | awk '{print $1}' | paste -sd ",")
MD5_DEBUG_2=$(md5sum czkawka_cli_debug_2 krokiet_debug_2 | awk '{print $1}' | paste -sd ",")
MD5_RELEASE_1=$(md5sum czkawka_cli_release_1 krokiet_release_1 | awk '{print $1}' | paste -sd ",")
MD5_RELEASE_2=$(md5sum czkawka_cli_release_2 krokiet_release_2 | awk '{print $1}' | paste -sd ",")

# Print MD5 hashes
echo "Printing CLI and Krokiet MD5 hashes"
echo ""
