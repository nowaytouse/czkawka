...
rust_rename_single_protected = Protected files cannot be renamed.
...
rust_protected_files_storage_error = The protected files list is unavailable: { $error }. Destructive file actions are blocked.
