...
settings_language_restart = इसके लिए ऐप को पुनरारंभ करने की आवश्यकता है
settings_common_label = सामान्य सेटिंग्स
settings_excluded_items = बहिष्कृत आइटम (ग्लोब पैटर्न, अल्पविराम से अलग किए गए)
settings_excluded_items_placeholder = उदाहरण के लिए: *.tmp, */.git/*, */node_modules/*
settings_allowed_extensions = अनुमत एक्सटेंशन (खाली = सभी)
...
settings_similar_images_header = समान छवियाँ
...
settings_gallery_image_fit_cover_desc = टाइल को भरें; मूल पहलू अनुपात बनाए रखने के लिए इसे निष्क्रिय करें
settings_big_files_header = सबसे बड़ी फ़ाइलें
settings_search_mode = खोज मोड
settings_file_count = फ़ाइल गणना
settings_same_music_header = संगीत की प्रतियां
settings_music_check_method = तुलनात्मक मोड
settings_music_compare_tags_label = तुलना किए गए टैग
settings_music_title = शीर्षक
settings_music_artist = कलाकार
settings_music_year = वर्ष
settings_music_length = लंबाई
...
stage_scanning_size = आकार के अनुसार स्कैन करना
stage_pre_hash = पूर्व-हैशिंग
stage_full_hash = हैशिंग
stage_loading_cache = कैश लोड हो रहा है
stage_saving_cache = कैश सहेज रहा है
stage_calculating_image_hashes = छवि हैश की गणना करना
stage_comparing_images = छवियों की तुलना करना
stage_calculating_video_hashes = वीडियो हैश की गणना करना
stage_checking_files = फ़ाइलों की जाँच की जा रही है।
stage_checking_extensions = एक्सटेंशन की जाँच की जा रही है
stage_checking_names = नामों की जाँच
stage_reading_music_tags = संगीत फ़ाइलों के मेटाडेटा को पढ़ना
stage_comparing_tags = टैग की तुलना करना
stage_calculating_music_fingerprints = संगीत की पहचान (फिंगरप्रिंट) की गणना करना
stage_comparing_fingerprints = उंगलियों के निशान की तुलना करना
stage_extracting_exif = EXIF टैग पढ़ना
stage_creating_video_thumbnails = वीडियो थंबनेल बनाना
stage_processing_videos = वीडियो संसाधित किए जा रहे हैं
stage_deleting = फ़ाइलों को हटाना
stage_renaming = फ़ाइलों का नाम बदलना
stage_moving = फ़ाइलों को स्थानांतरित करना
stage_hardlinking = हार्ड लिंक बनाना
...
option_check_method_size_and_name = आकार + नाम
