...
fn change_language(gui_data: &GuiData) {
    ...
    let lang_short = get_language_from_combo_box_text(&drop_down_selected_text(&gui_data.settings.combo_box_settings_language).expect("No selected language")).short_text;
