...
fn test_similar_images() {
    ...
    for (idx, (hash_alg, filter_type, hash_size, similarity, duplicates, groups, all_in_similar)) in algo_filter_hash_sim_found.into_iter().enumerate() {
        let params = SimilarImagesParameters::new(similarity, hash_size, hash_alg, filter_type, false, false, false, 0.0, false);
...
fn test_similar_images_exclude_same_size() {
    ...
    let params = SimilarImagesParameters::new(10, 8, HashAlg::Gradient, FilterType::Lanczos3, true, false, false, 0.0, false);
...
fn test_similar_images_empty_directory() {
    ...
    let params = SimilarImagesParameters::new(10, 8, HashAlg::Gradient, FilterType::Lanczos3, false, false, false, 0.0, false);
